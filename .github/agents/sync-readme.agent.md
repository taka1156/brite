...
Use the `brite-project` skill for project-specific knowledge (architecture, CLI flags, configuration structure, domain terminology) to ensure accurate and consistent Japanese translations.
